...
## 安装
 ...
 1. 安装包文件
	...
	``` bash
	$ composer require Zhaoweizhong/laravel-geetest
	```
...
1. 注册 ServiceProvider:
	...
	```php
	Zhaoweizhong\Geetest\GeetestServiceProvider::class,
	```

2. 添加 Alias

     ```php
     'Geetest' => Zhaoweizhong\Geetest\Facades\Geetest::class,
     ```

3. 创建配置文件、视图级资源文件：

	```shell
	php artisan vendor:publish --provider='Zhaoweizhong\Geetest\GeetestServiceProvider'
	```
